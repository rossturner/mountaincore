...
import technology.rocketjump.mountaincore.ui.widgets.tooltips.I18nTextElement;

import static org.fest.assertions.Assertions.assertThat;
import static technology.rocketjump.mountaincore.ui.i18n.LanguageType.DEFAULT_LINE_LENGTH;
...
public class I18nTextTest {
	...
	public void breakAfterLength_breaksAroundReplacements() {
		...
		I18nText text = i18nTranslator.getTranslatedString("TUTORIAL.START.INTRO_2").breakAfterLength(DEFAULT_LINE_LENGTH);

		// Previously this did not insert a line break
		assertThat(text.getElements().get(0).getText()).isEqualTo("Your intrepid band of dwarven settlers have chosen this area to found a new colony of their kingdom. Provide food,");
