...
import technology.rocketjump.mountaincore.mapping.tile.floor.RiverTile;
...
public class WaterFlowCalculatorTest {
	...
	public void setUp() throws Exception {
		...
		mapGenWrapper = Guice.createInjector(new MountaincoreGuiceModule()).getInstance(MapGenWrapper.class);
	}
