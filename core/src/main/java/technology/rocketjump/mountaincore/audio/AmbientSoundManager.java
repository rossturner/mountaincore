...
public class AmbientSoundManager implements Updatable, AssetDisposable {
	...
	public AmbientSoundManager(SoundAssetDictionary soundAssetDictionary, UserPreferences userPreferences) {
		...
		String volumeString = userPreferences.getPreference(UserPreferences.PreferenceKey.AMBIENT_EFFECT_VOLUME);
		this.ambientEffectVolume = SoundEffectManager.GLOBAL_VOLUME_MULTIPLIER * Float.valueOf(volumeString);
	}
	...
	public void setAmbientEffectVolume(Float newVolume) {
		this.ambientEffectVolume = newVolume * SoundEffectManager.GLOBAL_VOLUME_MULTIPLIER;
		userPreferences.setPreference(UserPreferences.PreferenceKey.AMBIENT_EFFECT_VOLUME, String.valueOf(newVolume));
	}
