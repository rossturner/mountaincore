package technology.rocketjump.mountaincore.mapgen.generators;

import com.badlogic.gdx.math.GridPoint2;
import technology.rocketjump.mountaincore.mapgen.calculators.RegionCalculator;
import technology.rocketjump.mountaincore.mapgen.model.AbstractGameMap;
import technology.rocketjump.mountaincore.mapgen.model.BinaryGrid;
import technology.rocketjump.mountaincore.mapgen.model.HeightGameMap;
import technology.rocketjump.mountaincore.mapgen.model.VertexGameMap;
import technology.rocketjump.mountaincore.mapgen.model.input.GameMapGenerationParams;
import technology.rocketjump.mountaincore.mapgen.model.input.GemType;
import technology.rocketjump.mountaincore.mapgen.model.input.OreType;
import technology.rocketjump.mountaincore.mapgen.model.output.*;
...
public class GameMapGenerator {
	...
	public GameMapGenerator(GameMapGenerationParams generationParams, Random random) {
		...
		vertexMap.set(0, 0, MidpointDisplacement.vary(0f, heightmapVariance, random));
		vertexMap.set(0, 1, MidpointDisplacement.vary(0f, heightmapVariance, random));
		vertexMap.set(1, 0, MidpointDisplacement.vary(0f, heightmapVariance, random));
		vertexMap.set(1, 1, MidpointDisplacement.vary(0f, heightmapVariance, random));
	}
