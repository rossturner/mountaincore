...
import technology.rocketjump.mountaincore.military.MilitaryMessageHandler;
import technology.rocketjump.mountaincore.military.model.MilitaryShift;
...
public class SquadSelectedGuiView implements GuiView, GameContextAware, Telegraph {
	...
	enum SquadCommand {
		TRAIN("icon_military_orders_training", MessageType.MILITARY_SQUAD_ORDERS_CHANGED, squad -> new SquadOrderChangeMessage(squad, SquadOrderType.TRAINING)),
