...
import technology.rocketjump.mountaincore.rendering.RenderingOptions;
import technology.rocketjump.mountaincore.rendering.RoomRenderer;
import technology.rocketjump.mountaincore.rendering.TerrainRenderer;
...
import technology.rocketjump.mountaincore.rendering.mechanisms.MechanismsViewModeRenderer;
import technology.rocketjump.mountaincore.rendering.piping.PipingViewModeRenderer;
import technology.rocketjump.mountaincore.rendering.roofing.RoofingViewModeRenderer;
...
import technology.rocketjump.mountaincore.sprites.IconSpriteCache;
import technology.rocketjump.mountaincore.sprites.TerrainSpriteCache;
import technology.rocketjump.mountaincore.zones.Zone;

import java.util.*;

import static technology.rocketjump.mountaincore.mapping.MapMessageHandler.getAttackableCreatures;
...
import static technology.rocketjump.mountaincore.rendering.custom_libgdx.ShaderLoader.defaultShaderInstance;
import static technology.rocketjump.mountaincore.rooms.RoomTypeDictionary.VIRTUAL_PLACING_ROOM;
import static technology.rocketjump.mountaincore.ui.GameInteractionMode.*;
import static technology.rocketjump.mountaincore.ui.GameViewMode.JOB_PRIORITY;
	...
	public boolean renderEntityMasks(OrthographicCamera camera, GameContext gameContext) {
		...
		if (hasEntitySelected || hasTargets || hasSquadSelected || hasConstructionSelected) {
			...
			if (hasEntitySelected && selectable.getEntity() != null) {
				...
				while (selectableEntity.getLocationComponent().getContainerEntity() != null) {
					selectableEntity = selectableEntity.getLocationComponent().getContainerEntity();
				}
