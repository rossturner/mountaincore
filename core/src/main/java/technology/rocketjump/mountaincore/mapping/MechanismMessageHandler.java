...
import technology.rocketjump.mountaincore.entities.behaviour.mechanisms.PowerMechanismBehaviour;
...
import technology.rocketjump.mountaincore.messaging.types.MechanismConstructionMessage;
import technology.rocketjump.mountaincore.messaging.types.MechanismPlacementMessage;
import technology.rocketjump.mountaincore.messaging.types.TileConstructionQueueMessage;
import technology.rocketjump.mountaincore.messaging.types.TileDeconstructionQueueMessage;
		...
		for (CompassDirection powerTransmissionDirection : mechanismType.getPowerTransmission()) {
			...
			if (tileInDirection != null && tileInDirection.getUnderTile() != null) {
				...
				if (powerGridInDirection != null) {
					...
					if (attributesInDirection.getMechanismType().getPowerTransmission().contains(CompassDirection.oppositeOf(powerTransmissionDirection))) {
