...
import static technology.rocketjump.mountaincore.mapping.tile.CompassDirection.*;
...
public class OverlapLayout {
	...
	private static final FloorType baseType = new FloorType("Overlap Layout base floor type", null,
			-1L, GameMaterialType.OTHER, 0, 1, new OverlapType("temp none"), false, 1f, null, null, null, null, null);
	private static final FloorType overlapType = new FloorType("Overlap Layout overlapping floor type", null,
			-2L, GameMaterialType.OTHER, 1, 1, new OverlapType("temp organic"), false, 1f, null, null, null,  null, null);
