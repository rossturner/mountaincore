...
import technology.rocketjump.mountaincore.entities.ai.pathfinding.Map2DCollection;
...
import technology.rocketjump.mountaincore.messaging.types.AddWallMessage;
...
import static technology.rocketjump.mountaincore.settlement.notifications.NotificationType.MINING_COLLAPSE;
...
public class MiningCollapseManager implements Telegraph, Updatable {
	...
	private void triggerCollapse(GridPoint2 epicenter) {
		...
		Notification notification = new Notification(MINING_COLLAPSE, VectorUtils.toVector(epicenter), null);
