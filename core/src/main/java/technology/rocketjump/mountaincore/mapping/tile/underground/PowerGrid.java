...
import technology.rocketjump.mountaincore.entities.behaviour.furniture.PowerSourceBehaviour;
		...
		for (MapTile tile : tiles) {
			for (Entity entity : tile.getEntities()) {
				...
				if (entity.getType().equals(EntityType.FURNITURE)) {
					...
					if (poweredFurnitureComponent != null && VectorUtils.toGridPoint(entity.getLocationComponent().getWorldPosition()).equals(tile.getTilePosition())) {
