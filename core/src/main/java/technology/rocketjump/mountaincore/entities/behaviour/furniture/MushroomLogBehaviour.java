...
import static technology.rocketjump.mountaincore.entities.behaviour.furniture.MushroomLogBehaviour.MushroomLogState.*;
...
public class MushroomLogBehaviour extends FurnitureBehaviour implements Destructible, SelectableDescription, EntityCreatedCallback, Prioritisable {
	...
	private void createHarvestJob(GameContext gameContext) {
		...
		harvestJob.setJobLocation(VectorUtils.toGridPoint(parentEntity.getLocationComponent().getWorldOrParentPosition()));
