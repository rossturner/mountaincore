...
public class LiquidAllocation implements Persistable {
	...
	private GameMaterial liquidMaterial = GameMaterial.NULL_MATERIAL;
	...
	public void writeTo(SavedGameStateHolder savedGameStateHolder) {
		...
		if (GameMaterial.NULL_MATERIAL.equals(liquidMaterial)) {
	...
	public void readFrom(JSONObject asJson, SavedGameStateHolder savedGameStateHolder, SavedGameDependentDictionaries relatedStores) throws InvalidSaveException {
		...
		if (this.liquidMaterial == null) {
			liquidMaterial = GameMaterial.NULL_MATERIAL;
		}
