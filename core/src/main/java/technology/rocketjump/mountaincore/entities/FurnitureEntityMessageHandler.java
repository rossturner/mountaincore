...
import technology.rocketjump.mountaincore.entities.tags.DecorationFromInputTag;
import technology.rocketjump.mountaincore.entities.tags.RequirementToColorMappingsTag;
...
import technology.rocketjump.mountaincore.mapping.RoofConstructionManager;
...
import static technology.rocketjump.mountaincore.rooms.constructions.ConstructionMessageHandler.findApplicableMaterial;
...
public class FurnitureEntityMessageHandler implements GameContextAware, Telegraph {
	...
	private void handleCreateFurniture(FurnitureCreationRequestMessage message) {
		...
		createdFurnitureEntity.getLocationComponent().setWorldPosition(VectorUtils.toVector(message.primarylocation), false);
