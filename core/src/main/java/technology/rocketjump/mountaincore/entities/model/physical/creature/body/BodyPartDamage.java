...
import static technology.rocketjump.mountaincore.entities.model.physical.creature.body.BodyPartDamageLevel.Bruised;
import static technology.rocketjump.mountaincore.entities.model.physical.creature.body.BodyPartDamageLevel.None;
...
public class BodyPartDamage implements ChildPersistable {
	...
	public OrganDamageLevel getOrganDamageLevel(BodyPartOrgan organ) {
		return organDamage.getOrDefault(organ, OrganDamageLevel.NONE);
	}
	...
	public void readFrom(JSONObject asJson, SavedGameStateHolder savedGameStateHolder, SavedGameDependentDictionaries relatedStores) throws InvalidSaveException {
		...
		if (organDamageJson != null) {
			for (int cursor = 0; cursor < organDamageJson.size(); cursor++) {
				...
				OrganDamageLevel organDamageLevel = EnumParser.getEnumValue(organDamageEntryJson, "level", OrganDamageLevel.class, OrganDamageLevel.NONE);
