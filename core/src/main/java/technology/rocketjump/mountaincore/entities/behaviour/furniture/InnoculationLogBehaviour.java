...
import static technology.rocketjump.mountaincore.entities.behaviour.furniture.InnoculationLogBehaviour.InnoculationLogState.*;
...
public class InnoculationLogBehaviour extends FurnitureBehaviour implements Destructible, SelectableDescription, Prioritisable {
	...
	private void createInnoculationJob() {
		...
		innoculationJob.setJobLocation(VectorUtils.toGridPoint(parentEntity.getLocationComponent().getWorldPosition()));
