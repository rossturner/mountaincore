...
import technology.rocketjump.mountaincore.entities.factories.names.LoadedFromCsv;
import technology.rocketjump.mountaincore.misc.SequentialId;
...
public class GenericClassTypeProcessor extends ModArtifactProcessor {
	...
	public void combine(List<ModArtifact> artifacts, Path tempDir) throws ModLoadingException {
		if (definition.combinationType.equals(ModArtifactDefinition.ArtifactCombinationType.ADDITIVE)) {
			if (definition.inputFileType.equals(ModArtifactDefinition.ModFileType.JSON_MAP) || definition.inputFileType.equals(ModArtifactDefinition.ModFileType.CSV)) {
