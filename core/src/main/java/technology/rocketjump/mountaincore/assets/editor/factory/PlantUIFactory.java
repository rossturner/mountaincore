...
import technology.rocketjump.mountaincore.assets.editor.model.PlantNameBuilders;
...
import technology.rocketjump.mountaincore.assets.editor.widgets.propertyeditor.plant.PlantSeasonsWidget;
import technology.rocketjump.mountaincore.assets.editor.widgets.propertyeditor.plant.PlantStagesWidget;
import technology.rocketjump.mountaincore.assets.editor.widgets.vieweditor.PlantAttributesPane;
...
public class PlantUIFactory implements UIFactory {
    ...
    public List<ColoringLayer> getApplicableColoringLayers() {
        return List.of(ColoringLayer.BRANCHES_COLOR, ColoringLayer.LEAF_COLOR, ColoringLayer.FRUIT_COLOR, ColoringLayer.FLOWER_COLOR, ColoringLayer.WOOD_COLOR, ColoringLayer.OTHER_COLOR, ColoringLayer.VEGETABLE_COLOR);
    }
