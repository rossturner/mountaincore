...
import static technology.rocketjump.mountaincore.materials.model.GameMaterialType.*;
...
public enum ColoringLayer {
	...
	// Creature layers
	HAIR_COLOR, SKIN_COLOR(SKIN), EYE_COLOR, ACCESSORY_COLOR, MARKING_COLOR, CLOTHING_COLOR,
