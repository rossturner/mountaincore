...
import technology.rocketjump.mountaincore.input.GameWorldInputHandler;
...
public class MainGameScreen implements GameContextAware, GameScreen, Telegraph {
	...
	private void updateGameLogic(float deltaTime) {
		...
		if (!gameContext.getGameClock().isPaused() && !gameContext.getSettlementState().getGameState().equals(GameState.SELECT_SPAWN_LOCATION) &&
				!gameContext.getSettlementState().getGameState().equals(GameState.STARTING_SPAWN)) {
