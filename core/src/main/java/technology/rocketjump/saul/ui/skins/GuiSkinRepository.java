...
public class GuiSkinRepository implements Telegraph {
	...
	private <T extends Skin> T loadSkin(String skinJsonPath, T skin) {
		...
		skin.add("default-font-14", onDemandFontRepository.getDefaultFont(14 * FONT_SCALE));
		...
		skin.add("default-font-21", onDemandFontRepository.getDefaultFont(21 * FONT_SCALE));
	...
	private void reassignFonts(Skin currentSkin, String pathToSkin) {
		...
		currentSkin.add("default-font-14", onDemandFontRepository.getDefaultFont(14 * 2));
