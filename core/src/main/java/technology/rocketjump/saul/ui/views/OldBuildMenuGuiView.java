...
@Singleton
public class OldBuildMenuGuiView implements GuiView {

	private List<IconButton> iconButtons = new LinkedList<>();

	@Inject
	public OldBuildMenuGuiView(IconButtonFactory iconButtonFactory, MessageDispatcher messageDispatcher) {
