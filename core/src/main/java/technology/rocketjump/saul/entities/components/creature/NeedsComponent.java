...
import technology.rocketjump.saul.entities.model.physical.creature.status.Exhausted;
import technology.rocketjump.saul.entities.model.physical.creature.status.VeryHungry;
import technology.rocketjump.saul.entities.model.physical.creature.status.VeryThirsty;
