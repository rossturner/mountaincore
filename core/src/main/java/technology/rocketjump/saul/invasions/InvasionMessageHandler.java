...
import technology.rocketjump.saul.invasions.model.InvasionTrigger;
...
public class InvasionMessageHandler implements Telegraph, GameContextAware {
	...
	private void triggerInvasion(InvasionDefinition invasionDefinition) {
		...
		messageDispatcher.dispatchMessage(4.5f, POST_NOTIFICATION, new Notification(NotificationType.INVASION, invasionLocation, null));
	}
